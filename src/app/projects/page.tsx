...
export const metadata = {
  title: "Projects — ProtoGrid",
  description: "Case studies — real tasks, solutions, and results from ProtoGrid.",
};
      ...
      <section className="py-12 lg:py-24 border-b border-iris-dusk/20">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <p className="font-sans text-[clamp(15px,1.1vw,17px)] leading-[1.68] text-lavender-smoke max-w-[48ch]">
            Every case below is a real task we received, worked through, and
            delivered. Task, solution, result — nothing more.
          </p>
        </div>
      </section>
